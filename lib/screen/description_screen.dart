...
import '../bloc/description_screen_bloc/description_screen_bloc.dart';
...
class _DescriptionScreenState extends State<DescriptionScreen> {
  ...
  SingleChildScrollView _body(BuildContext context, MovieDetail data) {
    return SingleChildScrollView(
      child: _movieContent(context, data),
    );
  }
